        ...
        const filteredMovies = movies.filter(function (movie) {
          ...
          return (
            ...
            filteredMovies.forEach( x => {
              ...
              const btnCard = document.createElement("button"); // crea un botón para cada pelicula del array filtrado
              btnCard.setAttribute("id", id); // agregamos la id de la pelicula al elemento
              btnCard.setAttribute("data-bs-toggle", "offcanvas"); // agrega atributos de boostrap para que funcione el top
              btnCard.setAttribute("data-bs-target", "#offcanvasTop");
              btnCard.setAttribute("aria-controls", "offcanvasTop"); 

              const card = document.createElement("li"); // crea un elemento li
              card.classList.add("list-group-item", "d-flex", "justify-content-between", "bg-dark", "text-white");
              card.innerHTML = // agrega contenido a la tarjeta de la pelicula, nombre y descripción 
              ...
              if (vote<=10 && vote>8) { // muestra las 5 estrellas
                card.innerHTML += `<div class="ms-auto p-2 bd-highlight">
